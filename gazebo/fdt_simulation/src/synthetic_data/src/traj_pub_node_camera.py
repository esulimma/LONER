...
pose_file_path = exp_dir + '/trajectory/camera_trajectory.txt'
...
if __name__ == '__main__':
    ...
    rospy.init_node('traj_pub_node_camera')
    ...
    while not rospy.is_shutdown():
        ...
        for pose in poses:
            rospy.logwarn('Publishing transform from /base_link to /camera/right')
            ...
            tf_l_msg.child_frame_id = 'camera/right'
